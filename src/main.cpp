...
void Ku_callback(const std_msgs::Float32MultiArray & robot_geometry)
{
  ku_m1_fd = robot_geometry.data[0];
  ku_m2_fg = robot_geometry.data[1];
  ku_m3_bd = robot_geometry.data[2];
  ku_m4_bg = robot_geometry.data[3];
